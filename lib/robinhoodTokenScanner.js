...
const ENABLED = String(process.env.ROBINHOOD_TOKEN_TRACKING_ENABLED || 'true').toLowerCase() !== 'false';
const PAGE_LIMIT = 50;
const CONCURRENCY = 5;
...
async function runRobinhoodTokenScan() {
  if (!ENABLED) return { disabled: true, reason: 'ROBINHOOD_TOKEN_TRACKING_ENABLED=false' };
