...
//
// `rpc` may be a string or an array. For Arc, the first endpoint is the
// official Arcscan gateway and the second is the configured backup endpoint.
const CHAINS = [
  {
    id: "eth",
    name: "Ethereum",
  ...
  },
  {
    ...
    // Arc mainnet chain id 5042. Use the official Arcscan gateway first;
    // automatically fail over to the configured backup RPC when unavailable.
    openseaSlug: null,
  },
  {
    id: "ink",
